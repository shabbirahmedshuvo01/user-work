...
const Sidebar = () => {
    return (
        <div>
            <section className='bg-sky-400 w-12 flex flex-col justify-center items-center gap-96'>
                <div className='mt-2 btn btn-ghost p-2'>
                ...
                <div className='mb-5 btn btn-ghost p-2'>
